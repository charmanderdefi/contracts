...
// CharmanderToken with Governance.
contract CharmanderToken is BEP20('Charmander', 'CHAR') {
    ...
    */
        ...
        external
    {
        ...
        require(now <= expiry, "CHAR::delegateBySig: signature expired");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying CHARs (not scaled);
